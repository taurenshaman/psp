  ...
  public class PSPEvent {
    ...
    public XElement ToXElement() {
      XElement xroot = new XElement( "event",
        ...
        new XAttribute( "time_start", time_start.ToString( "HH:mm:ss" ) ),
        new XAttribute( "time_end", time_end.ToString( "HH:mm:ss" ) ),
  ...
  public class TagReference {
    ...
    public static TagReference ParseSingle( XElement xroot ) {
      ...
      XAttribute xaName = xroot.Attribute( "name" ),
        ...
        xaTimes = xroot.Attribute( "referenced_times" );
      TagReference trNew = new TagReference( xaName.Value, new Guid( xaGuid.Value ) );
      trNew.referenced_times = xaTimes == null ? 0 : Convert.ToInt64( xaTimes.Value );
      return trNew;
    }
